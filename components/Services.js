...
export default function Services() {
  return (
    <section
      id="Services"
      className="py-32 -mt-16 overflow-hidden font-sans text-white bg-center bg-cover bg-quote md:-mt-20 md:py-28 "
    >
      <div className="px-8 ">
        <div className="flex flex-col justify-center ">
          <h1 className="pb-8 text-3xl font-semibold text-center md:text-4xl">
            SERVICES:
          </h1>

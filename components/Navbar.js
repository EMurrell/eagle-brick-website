      ...
      >
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              <motion.div
                className="flex flex-col mt-20 ml-12 text-2xl "
                initial="closed"
                animate="open"
                exit="closed"
              >
                ...
                {links.map(({ name, to, id }) => (
                  <motion.a
                    key={id}
                    href={to}
                    className="flex mt-12 ml-8 font-medium transition duration-100 ease-in-out transform hover:shadow-bottom w-max "

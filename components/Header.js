...
export default function Header() {
  return (
    <section className="flex flex-col justify-center w-full h-screen px-6 font-serif tracking-wider text-white bg-fixed bg-cover shadow-xl bg-hero bg-norepeat md:px-16 lg:px-32">
